...
import { CloseIcon, DragIcon, PlusIcon, SettingsIcon, TrashIcon } from '../common/icons';
...
export default function GroupManageModal({ groups, onClose, onSave }) {
  ...
  return (
    <ModalOverlay ariaLabel="管理分组" onClose={onClose}>
      <ModalCard style={{ maxWidth: '500px', width: '90vw' }}>
